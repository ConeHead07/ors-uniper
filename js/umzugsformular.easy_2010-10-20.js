...
function umzugsantrag_load_status(ASData) {
	...
	if (typeof(ASData)=="object") {
		...
		if (typeof(ASData["geprueft"])=="string") {
			...
			if (typeof(O("txtStatGepr"))=="object") O("txtStatGepr").innerHTML = (GP!="Init") ? " ".GP+" am "+ASData["geprueft_am"] : "";
		...
		if (typeof(ASData["genehmigt_br"])=="string") {
			...
			if (typeof(O("txtStatGen"))=="object") O("txtStatGen").innerHTML = (GN!="Init") ? " "+GN+" am "+ASData["genehmigt_br_am"] : "";;
		...
		if (typeof(ASData["bestaetigt"])=="string") {
			...
			if (typeof(O("txtStatBest"))=="object") O("txtStatBest").innerHTML = (BS!="Init") ? BS+" am "+ASData["bestaetigt_am"] : "";
		...
		if (typeof(ASData["abgeschlossen"])=="string") {
			...
			if (typeof(O("txtStatAbg"))=="object") O("txtStatAbg").innerHTML = (BS!="Init") ? BS+" am "+ASData["abgeschlossen_am"] : "";
...
function get_apnr(obj) {
	...
	if (typeof(optionsApnrByGER)=="object" 
	 ...
	 && optionsApnrByGER[g][e][r].length > 20) {
		SelBox_capture(SBBox, SBConfRaumnr, optionsApnrByGER[g][e]);
	} else {
		SelBox_capture(SBBox, SBConfRaumnr, PlaceHolder);
