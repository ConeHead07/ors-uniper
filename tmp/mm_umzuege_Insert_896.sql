...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 23.06.2016 um 10:21
Auftrag 193117, Asp. Frau Sieling Tel.66316, Termin: 29.06.2016 Umzug
für Christian Ackermann: Von Gebäude C151, R. 114 nach E47, R. 906
(Platz ist vor Ort beschriftet) 5 Umzugskartons, Monitor, Tastatur, Maus,
Docking Station, Telefon In KW25 Vorabanlieferungvon 5 Umzugskartons
  Etiketten nach Gebäude C151 R. 114",
