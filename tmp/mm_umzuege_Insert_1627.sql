...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 26.10.2016 um 06:43
Auftrag 209474 - Ansprechpartner: Hr. Pogarell, Tel. 65577 - Geb. C 302,
Raum 7 Entsorgung von E-Schrott lt. Bild im Anhang (Auftrag folgt per Mail):
2 Lesegeräte 1 grüne Kiste   5 Netzwerkkabel 1 alter Tischdrucker (steht
links, nicht auf dem Bild zu sehen) 1 Papierschneidemaschine Die Toner
werden vom Büromaschinendienst entsorgt.",
