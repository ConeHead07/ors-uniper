...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 17.11.2016 um 14:18
Auftrag 214056, Asp. Hr. Bebber, 62030, Termin: 24.11.2016 Gebäude
C152/1, Raum 213 Das Smartboard und den Kabelkanal demontierenund
entsorgen. Falls ein BBS-Asset-Aufkleber vorhanden ist: ein Foto machen
und der UZK zusenden",
