...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 06.04.2016 um 09:49
Bitte veranlassen Sie folgende Umzüge
Von Raum 2.M022, Geb. Q26 nach Raum 11, Geb. 4810, Raum 11

Albert Gasulla:             
 4 Umzugskartons   Hardware (Monitor, Dockingstation, Telefon, etc.)

Christian Kleffmann:    
 2 Umzugskartons   Hardware (2Monitor, Dockingstation, Telefon, etc.)

Reynaldo Isip:              
Hardware (Monitor, Dockingstation),1 Flipchart,1 Ventilator
1 Schreibtischlampe",
