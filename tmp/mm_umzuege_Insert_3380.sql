...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 06.07.2017 um 11:36
EXPRESS24h - Auftrag 261674, Asp. Fr. Seiler Tel. 36526, Termin:
06.07.2017 Gebäude C152/1 Der elektrisch Hv-Schreibtisch von Herrn
Bersenkovitz, C152-1, R306, wackelt/ist locker, bitte baldmöglichst
jemanden vorbeischicken zwecks Durchsicht/Reparatur",
