...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 12.07.2016 um 10:36
Auftrag 195389 - Brigitte Seiler, Tel. 36526 - C 152, R. 219 (falls der R. 411
verschlossen sein sollte) Lieferung aus dem BBS-Lager in C 151, Keller 1
von einem Bürodrehstuhl nach Geb. C 152-1, Raum 411 (Hr. Kämpchen)
Entsorgung des alten, defekten Bürodrehstuhls aus Raum 418 in C 152
(Druckerraum) freie Terminierung.",
