...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 30.06.2017 um 12:36
AA 260304 ASP.: FR. Hildebrandt Tel. 61048  Termin : 05.07.2017 im Laufe des Tages

In Geb.Q030, Keller 20 nach Raum 152 Transport und Aufstellung (nach Funktionalitätsprüfung) von :
1x Stehlampe (Waldmannleuchte)",
