...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 13.03.2017 um 11:02
AA 237943, Uwe Bebber 62030, Termin: 17.03.2017 (nach dem Umzug aus
R. 256) Geb.: C102, Raum 256 von R. 256 nach K002: 1 x Drehstuhl 5 x
Besucherstuhl Mauser blau 1 x weiteres Möbelstück (beschriftet mit K002)
von K002 nach R. 256: 1 x Rollcontainer (mit %u201ER. 256%u201C beschriftet) von K16
nach R. 256: 1 x 3OH-Theke (mit %u201ER. 256%u201C beschriftet)",
