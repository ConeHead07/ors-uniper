...
`umzugstermin` = NULL,
`umzugszeit` = NULL,
`terminwunsch` = "2016-05-31",
`ansprechpartner` = "Michael Katzler",
`ansprechpartner_email` = "m.katzler@mertens.ag",
`ansprechpartner_fon` = "01732661063",
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 13.05.2016 um 07:57
Auftrag 187482, Asp. Hr. El-Kassem, Termin: 

Gebäude E039, Umzüge innerhalb 4. OG

31.05.2016
%u2022	Anlieferung von 250 Kartons   500 Etiketten nach Gebäude E039, Raum 462, Frau Bauer

28.06.2016, 08:00 Uhr
%u2022	Packservice.
%u2022	Folgende Räume: 474, 472, 466a, 461a, 459a
%u2022	2 Mann ca. 5 Stunden

29.06.2016, 08:00 Uhr
Hausinterner Umzug von 25 Mitarbeitern mit IT ohne Möbel laut Mengengerüst",
