...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 22.05.2017 um 07:22
AA 252326, Fr. Schomacker 77177, Termin 24.05.2017 Vormittags In LEV
Geb. Q026, Raum 3.238 2 x Schreibtisch umstellen (mit IT) 2
xAktenschränke (6OH) umstellen (sind zum Termin leer)",
