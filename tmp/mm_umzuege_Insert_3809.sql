...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 04.09.2017 um 09:30
AA 271689 ASP.: Fr. Oelze Tel. 72332 Termin : 13.09.2017 im Laufe des
Tages Freigabe durch Herrn Sabet. Aus Geb. C302, Raum 003 nach Geb.
C305 (Deponie) zur Entsorgung : 1x (Siemens) defekter Kaffeevollautomat
(entkabelt ca.60x60) 1x (kleine) defekte Kaffeemaschine 1x (Logitech)",
