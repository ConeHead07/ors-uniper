...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 16.05.2017 um 07:19
Auftrag 251258, Asp. Fr. Täufler 53008, Termin: 22.05.2017 - zwischen 08:00 Uhr und 12:00 Uhr

aus Gebäude K009, Keller 007
%u2022	1 Jalousieschrank (2 OH, 1000 breit)
%u2022	1 Garderobe (grün 600 breit)
nach Gebäude 9426, Raum 208

In Raum 208 
%u2022	Garderobenschrank -> vorhandenen Boden tiefer setzen",
