...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 13.04.2017 um 09:03
AA 246136 ASP.: Fr. Kieselbach Tel. 65033 Termin : 20.04.2017 im Laufe
des Tages Innerhalb Geb. C151-BBS Lager nach Geb.C151, Raum 328
Transport von : 1x Schreibtisch, 1x Schreibtischrollcontainer 1x
Steelcase-Bürodrehstuhl Weiterhin bitte die Schreibtischhöhen in
Geb.C151, Raum 328 (Fr. Leuchter) und in Raum 318 (Hr. Boehm) nach
