...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 30.03.2017 um 11:14
AA 242577 Asp. Hr. Scherer / Hr. Büchel Termin 05.04.2017
 
Aus LEV Geb. E039 QSS-Lager nach LEV Geb. B106 1. OG
15 AP bestehend aus je
 
1 x Schreibtisch
1 x Rollcontainer (grün)
1 x Theke 3 OH 1m
1 x Bürodrehstuhl  
...
dort nach Möblierungsplan (siehe Anlage) aufstellen.",
