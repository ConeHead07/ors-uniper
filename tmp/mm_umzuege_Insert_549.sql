...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 14.04.2016 um 08:20
Auftrag 183208, Asp. Herr Schmuecking Tel.35208, ohne Terminvorgabe

8 Bürostühle entsorgen. Diese stehen derzeit im Gebäude E039,  3. OG im Raum 3.15.",
