...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 19.01.2018 um 06:41
AA 307865, Hr. Richtsteig 0214-30-58742, 19.01.2018 Aus LEV Geb. D162,
3. OG, Raum 334 (AP03 - Hr. Richtsteig) nach Geb. C151, BS-Lager 1 x
defekter Bürodrehstuhl (dort bitte als defekt markieren) Aus LEV Geb.
C151, BS-Lager nach Geb. D162, 3. OG, Raum 334 (AP03 - Hr. Richtsteig)
1 x Bürodrehstuhl",
