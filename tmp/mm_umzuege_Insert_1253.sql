...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 19.08.2016 um 08:19
Auftrag 200037 - Uwe Bebber, Tel. 62030 Aus Geb. C 102 Raum 4
folgendes einlagern in K 03 in C 102: 1 x Rollcontainer (beschriftet)in K03,
hinteres Regal 5 x Umzugskartons (beschriftet) in K03, im Regal Termin:
am 01.09.2016",
