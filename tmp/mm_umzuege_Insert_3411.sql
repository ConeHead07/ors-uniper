...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 11.07.2017 um 06:51
AA 262407, Hr. Bebber 62030, 17.07.2017
 
Von LEV Geb. C102 - K18 nach LEV Geb. C102, Raum 369
1 x Woodtec-Schrank aufstellen. (Bitte für 2 Schlüssel sorgen).
 
Zugang über ImmoService ist von Hr. Bebber beauftragt.",
