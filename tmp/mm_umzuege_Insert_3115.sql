...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 31.05.2017 um 10:16
AA 254767 ASP.: Fr. Stohl Tel. 62351 Termin : 06.06.2017 im Laufe des Tages
 
Innerhalb Geb. C151, BBS-Lager nach Raum 211 Transport von :
1x Bürodrehstuhl (neu)
 
Im Gegenzug innerhalb Geb. C151, Raum 211 nach BBS-Lager Transport und Einlagerung von :
1x defekter Bürodrehstuhl (bitte kennzeichnen)",
