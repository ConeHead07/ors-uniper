...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 08.07.2016 um 12:08
Auftrag 195178 Termin: Donnerstag, 14.07.2014 im Laufe des Vormittags
Umzug für Sandra Horn Tel. 46149 IST: LEV - Geb. 4810 Raum 15 ZIEL:
LEV - Geb. C 151 - OG 4 - R- 425 Transport von IT Equipment inkl. Telefon
  Wiederanschluss im Zielraum 1 Karton (keine Vorablieferung erforderlich)
1 Swopper (ergonom. Bürostuhl) Auftrag zusätzlich per Mail",
