...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 29.09.2016 um 06:38
Expressauftrag 48h 204844, Asp. vor Ort/Terminabsprache: Herr Baldringer, Tel.: 0175 30 25008 Termin: Donnerstag, den 29.09.2016 - 8:00 Uhr

Aus Gebäude E028 (BRE-Lager)
%u2022	1 Schreibtisch (K N) %u2013 1800 breit
nach Gebäude 4818, Foyer (rechte Seite)",
