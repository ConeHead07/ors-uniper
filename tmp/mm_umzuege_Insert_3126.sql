...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 01.06.2017 um 21:41
AA 255094; Herr Junkersdorf, Tel. 42756; Termin am 07.062017
 
Transport/Austausch
 
aus Gebäude D162 Raum 734  AP4 
- 1 Bürostuhl (defekt)
nach Gebäude C151 BBS Lager Keller
 
aus Gebäude C151 BBS Lager Keller
- 1 Bürostuhl (neu)
nach Gebäude D162 Raum 734 AP4
 
die Armlehne hält nicht mehr(Schraube gebrochen)",
