...
`raumnr` = NULL,
`etage` = "1. OG",
`kostenstelle` = "4501753755",
`planonnr` = "314925",
`umzug` = "Nein",
`umzugstermin` = NULL,
`umzugszeit` = NULL,
`terminwunsch` = "2018-02-19",
`ansprechpartner` = "Stefan Laschewski",
`ansprechpartner_email` = "s.laschewski@mertens.ag",
`ansprechpartner_fon` = "0177-9699495",
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 19.02.2018 um 07:25
AA314925 ASP.: Hr. Schoch Tel.33331 Termin : 19.02.2018 Innerhalb
Geb. Q030, Raum 653 nach Keller 20 Einlagerung von : 1x Stehlampe
Artemide Im Gegenzug aus Keller 20 nach Raum 653
Transport von : 1x Stehlampe Artemide Die defekte Stehlampe bitte
markieren, beim Defekt handelt es sich um eine unstabile Verbindung
zwischen Lampenfuﬂ und Aufbau",
