...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 23.01.2018 um 11:27
AA 309002 ASP.: Hr, Neupert Tel. 54043 Termin : 31.01.2018 Aus Geb.
C151, BS-Lager (Raum 003) nach Geb.C102, Raum 254 Transport von : 1x
Bürodrehstuhl Im Gegenzug aus Geb. C102, Raum 254 nach Geb. C305
(Deponie) Entsorgung von : 1x (alter) Bürodrehstuhl",
