...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 17.03.2017 um 08:28
AA 239561, Asp. Herr Bebber, Termin 22.03.2017 Von LEV Geb. C102,
Kellerraum K16 nach LEV Geb. C102, Raum 351 1 x Besprechungstisch
160x80cm (mit %u201ER. 351%u201C beschriftet) Von LEV Geb. C102, Raum 351 nach
LEV Geb. C102, Kellerraum K16 1 x Besprechungstisch",
