...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 29.06.2016 um 10:44
Auftrag 193919, Asp. Hr. Büchel, Termin: 06.07.2016

%u2022	1x Theke 2 OH 1,20 aus Lager FK 39 nach Geb. Q 26, Raum 0.006

%u2022	1x Theke 3 OH 1,20 aus Lager FK 39 nach Geb. Q 26, Raum 0.005

Es existieren hierzu keine Möblierungspläne, da es sich um zusätzliche Theken handelt. Aufstellung nach Angabe des Nutzers",
