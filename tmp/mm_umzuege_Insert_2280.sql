...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 06.02.2017 um 08:43
Auftrag 230815, Asp. Fr. Stohl 62351, Termin: ohne Terminvorgabe

Entsorgung
Gebäude C151, 2. OG Flur im Druckerbereich
%u2022	5 Mertens Umzugskartons (leer)
%u2022	1 defekter Stuhl 
%u2022	1 größerer Lenovo Karton (leer)",
