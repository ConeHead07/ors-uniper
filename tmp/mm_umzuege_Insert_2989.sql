...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 11.05.2017 um 13:11
AA 250577; Frau Kwade, Tel. 56537; Termine am Montag, den 15.05.2017
Transport in Gebäude C102 aus Gebäude C151 in den Raum 218 (Selim
Özmert) - 1 höhenverstellbarer Schreibtisch aus Gebäude C151 BBS Lager
Keller aus Raum 218 (Selim Özmert) - 1 Schreibtisch in das Gebäude
C151 BBS Lager (Keller)",
