...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 25.10.2017 um 09:28
AA 282249, Fr. Stratmann 0214-30-53829, 07.11.2017 Aus LEV Geb.
C152/1, EG, Raum 406 nach Geb. C151, BS-Lager 1 x Rollschrank (defekt)
Aus LEV Geb. C151, BS-Lager nach Geb. C152/1, EG, Raum 406 1 x
Rollschrank",
