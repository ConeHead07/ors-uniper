...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 21.09.2016 um 07:32
Auftrag 203951, Asp. Fr. Weesbach 28026, Termin: 04.11.2016
Vorabanlieferung von 2 Kartons am: 04.10.2016 nach Gebäude C102, Raum
251 z. Hd. Hr. Rocks Umzug Hr. Herr Rocks Aus Gebäude C102, Raum
251 nach Gebäude W008, Raum 102 Equipment (2x Bildschirm, 1x
Dockingstation, 1x Cisco IP-Telefon, 1x Schreibtischstuhl).",
