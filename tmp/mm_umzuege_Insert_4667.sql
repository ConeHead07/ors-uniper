...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 16.01.2018 um 15:13
Expressauftrag 24h 307118, Asp.Fr. Quentmeier, Termin: 17.01.2018 4
neue Umzugkartons zum Kauf samt Etiketten nach Gebäude Q30, 6.OG,
Raum 662 (Helma Quentmeier).",
