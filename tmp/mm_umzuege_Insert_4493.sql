...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 14.12.2017 um 11:17
Auftrag 284719, Asp. Fr. Reidenbach 53066, Termin 20.12.2017
Nachgangsarbeiten in W 11, OG 1 Ostseite Mengengerüst:
Ausrichtung/Einstellung ca. 100 Monitore an Monitorarmen Umstellung ca.
10 Möbelstücke (Rollcontainer/SideBoard) Umstellung von ca. 15 Kartons",
