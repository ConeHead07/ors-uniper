...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 11.04.2016 um 09:30
Bitte Tauschen Sie den Schreibtisch von Herrn Kasbe im Geb. C152/1, Raum 308 gegen einen elektrisch höhenverstellbaren Schreibtisch aus dem BBS-Lager aus.",
