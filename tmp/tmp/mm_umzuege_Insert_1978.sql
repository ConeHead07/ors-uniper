...
`raumnr` = NULL,
`etage` = "1. OG",
`kostenstelle` = "4501509091",
`planonnr` = "220727",
`umzug` = "Nein",
`umzugstermin` = NULL,
`umzugszeit` = "08:00:00",
`terminwunsch` = "2016-12-30",
`ansprechpartner` = "Stefan Laschewski",
`ansprechpartner_email` = "s.laschewski@mertens.ag",
`ansprechpartner_fon` = "0177-9699495",
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 22.12.2016 um 06:43
Auftrag 220727, Asp. Hr. El-Kassem, Termin: 30.12.2016 - 08:00 Uhr
Großraumbüro im B106, Raum 111 8 * IT von B106 nach D162
umzuziehen. 7x Inklusive Kabelmanagement Auf der Rückseite der
Monitore sind die neuen Standorte mit Gebäude, Raum und AP vermerkt.1
Monitor wird nicht angeschlossen, bitte nur wie ausgeschildert abstellen",
