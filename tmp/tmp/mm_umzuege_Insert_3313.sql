...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 29.06.2017 um 07:51
Auftrag 259916, Asp. Fr. Selbach 44936, Termin: 17.07.2017 danke für die
Info, dann planen Sie den Umzug bitte für den 17.07. Gebäude Q030 Frank
Hubbuch (IMHUB) R. 259 > R. 359 Markus Hauswald (PHH)
R. 257 > R. 355 Folgendes wird umgezogen: IT-Hardware (Monitore,
Dockingstation, Telefone) Rollcontainer Kartons Bilder 1 Bronze-Skulptur
(Hubbuch)",
