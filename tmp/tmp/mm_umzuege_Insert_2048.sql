...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 09.01.2017 um 09:13
Auftrag 224588, Ansprechpartner vor Ort: Frau Sandra Brenzinger, Tel.:
39739, Termin : 11.01.2017 - Vormittags Transport einer Stehleuchte
(Waldmann) von Geb. 4809, R. 405 (steht rechts in der Nische;
gekennzeichnet) nach Geb. C152 / 2, R. 1.604, Herrn Block.",
