...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 24.11.2016 um 11:36
EXPRESS Auftrag 24h, Asp. Hr. Büchel/Scherer, Termin: 25.11.2016 - Vormittags

Transport Mobiliar aus Gebäude E39 Lager > Gebäude Q026_EG Raum 0.033:

%u2022	1 höhenverstellbarer Schreibtisch, 1 Rollcontainer mit Schubladen,
%u2022	1 Bürodrehstuhl xenium classic -

Umstellen der bereits im Raum stehenden Möbel inklusive DV-Kabelmanagement -",
