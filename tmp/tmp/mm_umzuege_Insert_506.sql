...
`raumnr` = NULL,
`etage` = "1. OG",
`kostenstelle` = "4501352223",
`planonnr` = "182339",
`umzug` = "Nein",
`umzugstermin` = NULL,
`umzugszeit` = NULL,
`terminwunsch` = "2016-04-13",
`ansprechpartner` = "Michael Katzler",
`ansprechpartner_email` = "m.katzler@mertens.ag",
`ansprechpartner_fon` = "01732661063",
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 07.04.2016 um 10:02
AA 182339 Ansprechpartner Hr. Büchel 57478 Termin 13.04.2016
 
Bitte  Geb. E041 R.239 ausräumen, dh. bis zu 4 Schreibtische,3 Rollcontainer ,2 Stühle an am Umzugstag  angegebene Orte im Geb. E41 abstellen.",
