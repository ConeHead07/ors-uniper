...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 20.12.2017 um 10:08
AA 295720, Fr. Liebscher 0214-30-31959, 03.01.2018 Personenumzug:
Frau Heike Konze In LEV Geb. 9426 aus Raum 206 nach EG (Büro neben
dem Pförtner), Raum 00001_AP03 2 x Kartons 2 x Monitore (im Zielraum
bitte an die Trennwand anbringen) 1 x IT (Dockingstation, Telefon, Tastatur)",
