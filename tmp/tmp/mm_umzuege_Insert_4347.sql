...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 21.11.2017 um 07:22
Auftrag 287410, Asp. Frau Thoerner, Termin 29.11.2017 Umzug Frau
Thörner zum 01.12. an den Standort Monheim Transport 2-3
Umzugskartons Die Kartons stehen in Q 30, R. 505 und sollen nach
Monheim Geb, 6210, Raum 1.56",
