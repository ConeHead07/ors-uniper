...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 09.08.2016 um 12:33
Std. Transport, verschieben sowie Ausrichten von 2 Schränken im Geb. C
102 Raum 205 nach R. 235 Umzug 1 Mitarbeiter von R. 205 nach R. 235,
Transport von IT-Equipment sowie Wiederanschluss im Zielraum. Termin:
heute, 09.08.16 - Express 24 Std. - Der Auftrag wird heute durch Hr. Mustafa
Yigitt erledigt.",
