...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 22.08.2016 um 08:00
Geb. C 102 Raum 20, Möbel einlagern wie folgt: Im K16 Geb. C102
einlagern: 1 Tisch 140x80cm (mit Haftnotiz beschriftet) Im K04 im Geb. C
102 einlagern: 1 Rollcontainer (mit Haftnotiz beschriftet)
1Blechgarderobenschrank (mit Haftnotiz beschriftet)",
