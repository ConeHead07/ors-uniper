...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 09.11.2016 um 13:56
Auftrag 212186 - Ansprechpartnerin: Brigitte Seiler, Tel. 36526

Termin: 14.11.16 

Umzug für
Alexander Heinrichs (am Umzugstag in Urlaub)
IST: LEV %u2013 Geb. E 47 %u2013 OG 04 - R. 404
ZIEL: LEV %u2013 Geb. B 151 %u2013 OG 10 - R. 1048 %u2013 AP 01

Transport von:
1 Schreibtischlampe
1 Dockingstation (HDELEVC021A)
1 Bild (Tourplakat)
1 Umzugskarton (gepackt)
1 IP-Telefon Cisco (43210)

Das Transportgut ist beschriftet.",
