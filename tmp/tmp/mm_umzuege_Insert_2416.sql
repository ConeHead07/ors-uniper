...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 28.02.2017 um 10:28
AA 234887, Jörg Scherer / Erik Büchel 55058, Termin: 02.03.2017 im Laufe des Tages
 
Geb.: Q26, Raum 1.436
folgende Möbel zusätzlich möblieren:
 
1x höhenverstellbarer Schreibtisch
1x Rollcontainer mit Schubladen
1x Bürodrehstuhl xenium classic
 
Laut anliegendem Möblierungsplan.",
