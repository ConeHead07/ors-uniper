...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 08.06.2017 um 09:51
AA 256115 ASP.: Fr. Stohl  Tel. 62351 Termin : 14.06.2017 im Laufe des Tages
 
Innerhalb Geb.C151 aus dem BBS Lager nach Raum 217 Transport von :
1x Bürodrehstuhl 
Im Gegenzug aus Geb. C151, Raum 217 Entsorgung von :
1x Bürodrehstuhl (defekt)",
