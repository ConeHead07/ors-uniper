...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 16.11.2017 um 15:56
Auftrag 286917, Asp. Fr. Martenka, Termin: 27.11.2017 Abholung und
Entsorgung eines Trolleys (siehe Foto per Email) aus Geb. 4809R_405 Den
Barcode zum scannen bitte abziehen und mit dem Arbeitsschein dem
DLS-MUT übergeben.",
