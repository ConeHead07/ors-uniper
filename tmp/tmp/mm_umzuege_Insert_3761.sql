...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 24.08.2017 um 07:42
AA 270453 ASP.: Hr. Bebber Tel. 62030 Termin : 06.09.2017   

Innerhalb von Geb. C102 aus  Raum 1076 nach Keller 016:
1 x Liftschreibtisch

von Keller 002 nach Raum 1076:
3 x Schreibtisch 140x80cm 
1 x Rollcontainer

von Keller 016 nach Raum 1076:
2 x Drehstuhl

Stellplan ist dem Mail angefügt.",
