...
`raumnr` = NULL,
`etage` = "1. OG",
`kostenstelle` = "4501369421",
`planonnr` = "186098",
`umzug` = "Nein",
`umzugstermin` = NULL,
`umzugszeit` = NULL,
`terminwunsch` = "2016-05-10",
`ansprechpartner` = "Michael Katzler",
`ansprechpartner_email` = "m.katzler@mertens.ag",
`ansprechpartner_fon` = "01732661063",
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 03.05.2016 um 10:31
Auftrag 186098, Asp. Hr. Büchel/Scherer, Termin 10.05.2016 Möbel zur
Direktentsorgung aus Keller K232, Gebäude Q26: 9 Schränke 5
Untertischcontainer 1 Eck-Schreibtisch 2 runde Besuchertische 14
Besucherstühle 14 Bürostühle 2 Schreibtische",
