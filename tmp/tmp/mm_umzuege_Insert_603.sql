...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 20.04.2016 um 09:23
Auftrag 184343 - Olaf Mönch, Tel. 32535 Geb. B 151 - Aufräumarbeiten auf
der 8. Etage Westseite, so dass die Etage bezugsfertig wird. (Tischgruppen
zusammenstellen, Kabel sortieren, etc.) Ansprechpartner vor Ort ist Hr.
Mönch.",
