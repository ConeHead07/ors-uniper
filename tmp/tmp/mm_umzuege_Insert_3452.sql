...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 14.07.2017 um 10:55
AA 263281 ASP.: Fr. Suelue Tel.58382 Termin : 21.07.2017 10:00 Uhr

Von B151, R. 250,nach C102, Raum 023: 
1x (transportabler) Bildschirm

Von B151, R. 250 nach C102, Keller 003:
1x Beamer
5x (kleine) Kartons 
1x Kaffeeautomat (Kleingerät)",
