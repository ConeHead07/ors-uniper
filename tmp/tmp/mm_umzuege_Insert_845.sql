...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 15.06.2016 um 12:28
Auftrag 191990 - Uwe Bebber, Tel. 62030 Termin: bis zum 21.06.2016
Versetzen des eingezeichneten Woodtec-Elementes (folgt per Mail). Im
Gegenzug das Türschild an den neuen Raumeingang setzen.",
