...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 04.10.2017 um 08:00
AA 274184, Hr. Bebber 0214-30-62030, 19.09.2017 In LEV Geb. C102 aus
den Räumen 17-19 und 21-22 Ca. 15 beizustellende Umzugskartons mit
Papier, Hausmüll, Elektroschrott etc. füllen und entsorgen. Den Inhalt der
Rollcontainer und Theken auch entsorgen. Ca. 30 Magnete von der Wand
nehmen. Nach dem Auftrag sollen nur noch die Möbel und Pflanzen in den
Räumen stehen.",
