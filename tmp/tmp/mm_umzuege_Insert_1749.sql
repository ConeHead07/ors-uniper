...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 16.11.2016 um 10:54
Auftrag 213624, Asp. Hr. Büchel/Scherer, Termin: 22. 23.11.2016 - 08:00
Uhr Gebäude W002, Vorastandskeller Alle Möbel, die in den drei
Vorstandskellern in W 2 eingelagert sind, müssen fotografiert und
ausgemessen werden, so dass wir einen kompletten Katalog der
eingelagerten Gegenstände vorliegen haben.",
