...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 19.01.2017 um 11:54
Auftrag 227292, Asp. Fr. Heinz 82755, Termin 25.01.2017 In Büro 0.212
(Geb. Q 26) müssten ein paar Änderungen vorgenommen werden.Der 5 OH
Schrank (rechts) wird nicht mehr benötigt und soll bitte abgeholt und in
Keller 181 eingelagert werden. Zudem bitten den 5OH Schrank links ein
Stück zu verschieben. Er soll direkt neben die Tür geschoben werden.",
