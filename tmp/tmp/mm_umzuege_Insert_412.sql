...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 17.03.2016 um 17:57
C102 R.118     Entsorgung eines Smartboards und einlagerung des Besprechungstisches in C102 K04",
