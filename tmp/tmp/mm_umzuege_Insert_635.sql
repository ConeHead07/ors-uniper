...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 25.04.2016 um 19:06
Auftrag 184933, Asp. Hr. Büchel, Termin: 29.04.2016

Aus Gebäude Q26, Kellerräume 181/192  nach W11, Raum 210 transportieren:

%u2022	1 höhenverstellbarer Schreibtisch
%u2022	1 Rollcontainer mit Schubladen
%u2022	1 Bürodrehstuhl EasySit (hohe Lehne)
%u2022	2 Theken 2 OH 1200
%u2022	1 Garderobe",
