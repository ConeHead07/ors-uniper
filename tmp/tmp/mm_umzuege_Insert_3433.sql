...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 12.07.2017 um 11:40
AA 262814 ASP.: Fr. Liebsch Tel. 81900 Termin : 19.07.2017 im Laufe des Tages

Innerhalb Geb.W004, Raum 328 (türseitig links) nach Möbelkeller Demontage und Transport von :
2x (miteinander verbundene) Schränke 

Innerhalb, Raum 328 (türseitig rechts) Umstellung nach links von :
1x Einzelschrank",
