...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 06.02.2017 um 10:10
Auftrag 231082 - Brigitte Seiler, Tel. 36526

Geb. C 152-1, R214 (Druckerraum hellblaues-türkises Haus) 

Abholung von zwei defekten Bürodrehstühlen (bei einem die Rückenlehne gebrochen, beim anderen der Stoff durchgesessen) 

und 5 leeren Umzugskartons aus vergangenen Umzügen. Freie Terminierung!",
