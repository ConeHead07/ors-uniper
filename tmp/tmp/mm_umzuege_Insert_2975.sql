...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 09.05.2017 um 10:15
AA 250213 ASP.: Fr. Koitzsch Tel. 45891 Termin 17.05.2017
 
Innerhalb von Geb.W004, Raum 129 nach Keller (Möbellager) Transport von :
1x Aktenschrank
1x Sideboard 
 
 
Aus  Geb. W004, Raum 129 nach Raum 212:
1x Sideboard 
 
Im Gegenzug aus Raum 212 nach (Druckerraum)  M0244:
1x Sideboard",
