...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 28.07.2016 um 12:21
Auftrag 197436 - Herr Bebber Tel. 62030 Termin: 03.08.2016 mit dem
Auftrag 197427 erledigen Von C102, R. 05 nach C151, R. 35: 4 x Barhocker
1 x höhenverstellbarer Besprechungstisch in C102, R. 05, dafür aufstellen:
1 x Besprechungstisch rund in Buche/Schwarz aus K16 4 x Besucherstuhl
Dauphin aus K16",
