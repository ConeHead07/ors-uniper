...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 31.01.2017 um 08:32
Auftrag 229177, Asp. Hr. Stengele, Termin: 06.02.2017 Gebäude C102,
Raum 251 2 Tische müssten in der Höhe verstellt werden und die
Arbeitsplätze um ca. 2 m Richtung Fenster verschoben werden. Inklusive
DV-Kabelmangement Dazu werden auch längere Anschlusskabel für
Strom, Netzwerk (PC) und Telefon benötigt.",
