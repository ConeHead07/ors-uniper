...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 01.02.2017 um 08:58
Auftrag 230147, Asp.Fr. Rathien Tel. 0214-30-39918, Termin: 08.02.2017
Gebäude D162, 1. OG gegenüber den Postfächern ist eine Nische, in der
die BBS-ITO-S2P-Mitarbeiter die leeren Umzugskartons zurückgegeben und
Altgeräte zur Entsorgung abgestellt haben. Entsorgung ca. 20 nicht mehr
gängige PC-Bildschirme und Kartons mit Tastaturen oder Kabel).",
