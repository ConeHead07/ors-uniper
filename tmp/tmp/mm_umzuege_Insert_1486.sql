...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 29.09.2016 um 09:55
Bilderleiste im R. 1111 muss gelöst u. verschoben werden (ist z. Zt.
verschraubt) Die benötigten Nutensteine liegen im K03 in C 102 linke
Schrankreihe vorletzter Schrank. 2 Bilder aufhängen im Raumauf Ansage
von Fr. Jenny Radach 2 Whiteboards aus R.1111 nach K 03 in C 102
Termin: Freitag, 07.10.2016 im Zeitfenster von 10 - 12 Uhr",
