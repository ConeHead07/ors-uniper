...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 17.10.2016 um 08:19
AA 207924 Ansprechpartner Hr. Scherer Termin 02.11.2016
 
Aus MON Geb. 6230 Raum 1.5 nach LEV Geb. Q030 Raum 305 rechter AP
 
1 Dockingstation
1 Bildschirm (mit Fuss)
2 Kartons
 
Aus Geb Q030 Keller 20 nach Raum 305 rechter AP
 
1 Monitorhalterung
 
Die Monitore sollen an Monitorhalterungen montiert werden. Der Auftrag ist mit DV Kabelmanagement.",
