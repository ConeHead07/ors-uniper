...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 13.06.2016 um 07:56
Auftrag 191518, C151, R217 - Frau Stohl. Aus BBS-Lager: 1x
Besprechungstisch, 5 x Besprechungsstuhl und Rücktransport 2 x Rundtisch
d= 70 cm in das BBS-Lager",
