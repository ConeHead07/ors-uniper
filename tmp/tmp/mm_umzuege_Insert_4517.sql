...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 18.12.2017 um 11:00
AA 294839 ASP.: Fr. Hamdorf Tel.71057 Termin : 03.01.2018 Aus Geb.
K009, Raum 834 nach Geb. C305 (Deponie) Entsorgung von : 3x
PLS-Gestelle 1x Protexxion-Schrank (ohne PC), 2x Meﬂwartenschr‰nke
Fotos hierzu werden separatem Mail angehangen. Ein jeweils
unterschriebener Durchlassschein liegt den Ger‰ten bei.",
