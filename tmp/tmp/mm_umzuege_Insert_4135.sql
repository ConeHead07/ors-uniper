...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 20.10.2017 um 07:11
AA 281201; Herr Schoch, Tel. 33331; Termin am 24.10.2017 um 8:00 Uhr
Transport innerhalb Gebäude Q030 6.OG aus Raum 618 - 1 doppelter
Kleiderschrank - 2 Garderobenschränke (1x Links & 1x Rechts) nach Raum
686 aus Raum 686 - 1 Aktenschrank (hinter dem Schreibtisch) - 1
Garderobenschrank - 1 Pflanze (silberner Topf) nach Raum 618",
