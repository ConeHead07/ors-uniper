...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 28.06.2016 um 11:49
Auftrag 193646, Asp. Hr. Büchel/Scherer, Termin: 01.07.2016 - 09:00 Uhr

Umzug Frau Anja Weber  
Folgende Sachen müssen von W4, R.0039 (EG) nach E61, R.107 (1.OG) transportiert werden:

IT-Equipment (Bildschirm, Docking-Station, Tastatur, Maus und Telefon) 
Ca. 2-3 Umzugskartons",
