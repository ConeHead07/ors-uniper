...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 12.07.2017 um 10:16
AA 262804 ASP.: Hr. Wortmann Tel. 54330 Termin: 31.07.2017 09:00 Uhr
Umzug von Hr.Wortmann aus Geb. D162,Raum 326 nach Geb. 4818 ,Raum
275 (AP01) mit : 3x U-Kartons (bereits vorhanden); 1x Dockingstation; 2x
Monitor; 1x Laptop; 1x Tastatur Arbeiten inkl. DV-Kabelmanagement",
