...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 21.04.2017 um 07:16
AA 247019, Fr. Buff 33993, Termin 26.04.2017 Von LEV Geb. B151, Raum
847 2 x Stühle (anthrazit/schwarz - markiert) 1 x kleiner runder
Besprechungstisch (anthrazit/schwarz - markiert) Raum 845 1 x
Metaplanwand (steht im Raum) nach C151 BBS-Lager Kellerraum 001/002",
