...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 12.04.2016 um 12:14
Auftrag 182893, Asp. Hr. Scherer/Büchel, ohne Terminvorgabe

Gebäude K56:
Externe Entsorgungvon Insgesamt ca. 45 Paletten verschiedener Größen. Weiterhin ein Holzgestell Groß ca. 200 KG. 
