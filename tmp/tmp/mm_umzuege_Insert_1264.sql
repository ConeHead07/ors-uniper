...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 22.08.2016 um 07:52
Auftrag 200167, Asp. Hr. Scherer, Termin: 

In Gebäude B407, Raum 415,  die Möbel  am 06.09. um 8 Uhr ausgeräumen  (Zwischenlagerung auf dem Flur) und am 09.09. wieder eingeräumen 

%u2022	2 HV-Schreibtische
%u2022	2 Highboards,
%u2022	2 hohe Schränke 
%u2022	2 Minischränke.

Fluchtwege frei lassen.",
