...
`raumnr` = NULL,
`etage` = "1. OG",
`kostenstelle` = "4501615841",
`planonnr` = "256831",
`umzug` = "Nein",
`umzugstermin` = NULL,
`umzugszeit` = NULL,
`terminwunsch` = "2017-06-16",
`ansprechpartner` = "Stefan Laschewski",
`ansprechpartner_email` = "s.laschewski@mertens.ag",
`ansprechpartner_fon` = "0177-9699495",
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 14.06.2017 um 10:21
Auftrag 256831, Asp. Fr. Beck 25679, Termin: 16.06.2017 - Vormittag
(Kunde ist am Nachmittag nicht da!!!! Gebäude Q030: Transport
Kaffeeautomaten (sehr schwer, Name Primadonna) vom Kellerraum 19, in
Geb. Q 30, rechte hintere Ecke ganz oben auf dem Regal nach Geb. Q 26,
Raum 1.019 bringen. Aus Geb. Q 30, Raum 130 einen Umzugskarton
nach Geb. Q 26, Raum 1.019 bringen.",
