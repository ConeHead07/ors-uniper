...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von m.katzler am 21.02.2018 um 11:22
vorab %u2026
AA 315423 ASP.: Fr. Seiler Tel. 36526  Termin : 02.03.2018  09:00 Uhr
 
Aus Geb : B151, Raum 215 nach Geb. C151, BS-Lager Einlagerung von :
1x Schreibtischkombi (2 Teile)
1x Besuchertisch (rund)
2x Besucherstühle
1x Rollcontainer 
1x Standcontainer
 
Im Gegenzug aus Geb. C151, BS-Lager nach Geb. B151,Raum 215 Transport von :
2x Schreibtische R&G 
2x Rollcontainer 
1x Bürodrehstuhl
Aufstellung nach Info vor Ort.",
