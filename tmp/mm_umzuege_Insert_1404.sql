...
`raumnr` = NULL,
`etage` = "1. OG",
`kostenstelle` = "4501446746",
`planonnr` = "203400",
`umzug` = "Nein",
`umzugstermin` = NULL,
`umzugszeit` = NULL,
`terminwunsch` = "2016-09-21",
`ansprechpartner` = "Stefan Laschewski",
`ansprechpartner_email` = "s.laschewski@mertens.ag",
`ansprechpartner_fon` = "0177-9699495",
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 15.09.2016 um 10:53
203400, Asp. Melder : Uwe Bebber %u2013 Tel.: 62030, Termin: Mittwoch, 21.
September 2016 Umzug 1 Person : Monika Kissener-Miloch IST:
LEV-C102-OG01-1055 %u2013AP02 ZIEL: LEV-C102-OG01-1075 %u2013AP01 -
IT-Equipment und IP-Telefon umziehen - Schreibtischhöhe einstellen - außer
Rollcontainer und orth. Stühlen werden keine Möbel umgezogen !",
