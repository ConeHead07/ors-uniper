...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 19.07.2016 um 10:53
Auftrag 196287 - Uwe Bebber, Tel. 62030 Termin: Erledigung bis zum
22.07.2016 Geb. D 167 Das im Raum 007 auf AP04 stehende
DV-Equipment abklemmen, in einen Umzugskarton packen (Karton bitte
mitbringen) und auf eines der Sideboards an der Wand stellen. Das
Equipment verbleibt im Raum 007. Zeichnung folgt zusätzlich per Mail.",
