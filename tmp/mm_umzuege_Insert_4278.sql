...
`geraete_csv` = NULL,
`bemerkungen` = "Bemerkung von slaschewski am 14.11.2017 um 07:36
AA 286041, Fr. Korczok 0214-30-72758, 22.11.2017 vormittags In LEV
Geb. 9426, 1. OG, Raum 125 2 x 3 2 OH Schränke innerhalb des Raumes
verschieben (ca. 80cm nach links zum Fenster) 2 x Garderobenschränke
innerhalb des Raumes verschieben (ca. 80cm nach links zum Fenster) 2 x
Monitore an vorhandene TFT Halter montieren",
