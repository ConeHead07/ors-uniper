    ...
    $.fn.uploadFile = function (options) {
        ...
        (function checkAjaxFormLoaded() {
            if($.fn.ajaxForm) {
                ...
                if(s.dragDrop) {
                    ...
                    $(obj).append(dragDrop);
                    if (!s.hideLabel) $(dragDrop).append(uploadLabel);
	   ...
	   this.startUpload = function () {
        ...
        function setDragDropHandlers(obj, s, ddObj) {
            ddObj.bind('dragenter', function (e) {
                e.stopPropagation();
                e.preventDefault();
                $(this).addClass(s.dragDropHoverClass);
            });
            ddObj.bind('dragover', function (e) {
                e.stopPropagation();
                e.preventDefault();
                var that = $(this);
            ...
            ddObj.bind('dragleave', function (e) {
                $(this).removeClass(s.dragDropHoverClass);
            });
