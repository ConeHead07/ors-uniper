...
//	"FormInput" => "html/leistungskatalog_eingabe.html",
	...
	"Fields" => array(
        ...
        "leistung_ref_id2" => array(
            "dbField" => "leistung_ref_id2",
            "key" => "",
            "label" => "Zubehör-Leistung-ID",
            "listlabel" => "Zubehör-LID",
            "fieldPos" => 2,
            "fieldGroup" => "main",
            "description" => "",
            "type" => "int",
            "size" => "11",
            "sql" => "Select leistung_id, Bezeichnung FROM {TABLE.leistungskatalog} WHERE IFNULL(leistung_ref_id, 0) = 0 AND leistungskategorie_id = 27",
            "sysType" => "int",
            "htmlType" => "select single",
            "default" => '0',
            "required" => false,
        ...
        "leistung_ref_id3" => array(
            "dbField" => "leistung_ref_id3",
            "key" => "",
            "label" => "Service-Leistung-ID",
            "listlabel" => "Service-LID",
            "fieldPos" => 2,
            "fieldGroup" => "main",
            "description" => "",
            "type" => "int",
            "size" => "11",
            "sql" => "Select leistung_id, Bezeichnung FROM {TABLE.leistungskatalog} WHERE IFNULL(leistung_ref_id, 0) = 0 AND leistungskategorie_id = 28",
            "sysType" => "int",
            "htmlType" => "select single",
            "default" => '0',
            "required" => false,
	...
	"Lists" => array(
		"0" => array(
			...
			"ListTemplate" => "",
			"name" => "",
			"select" => "aktiv, verfuegbar, leistung_abk, Bezeichnung, produkt_link, preis_pro_einheit, Farbe, Groesse, leistungskategorie_id",
