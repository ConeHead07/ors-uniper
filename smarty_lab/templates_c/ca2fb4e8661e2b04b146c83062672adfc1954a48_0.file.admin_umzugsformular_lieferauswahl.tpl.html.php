<?php
/* Smarty version 3.1.34-dev-7, created on 2020-01-15 08:35:52
  from '/application/html/admin_umzugsformular_lieferauswahl.tpl.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5e1ecee81f9802_68069034',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ca2fb4e8661e2b04b146c83062672adfc1954a48' => 
    array (
      0 => '/application/html/admin_umzugsformular_lieferauswahl.tpl.html',
      1 => 1577987866,
      2 => 'file',
    ),
  ),
...
function content_5e1ecee81f9802_68069034 (Smarty_Internal_Template $_smarty_tpl) {
...
<table id="InputDienstleister">
  <tr>
    ...
    <td style="padding:0;width:200px;"><input id="dl_firmenname" type="text" readonly="true" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['DL']->value['Firmenname'], ENT_QUOTES, 'ISO-8859-1', true);?>
" name="DL[Firmenname]" class="itxt itxt2col"></td>
  ...
  <tr>
    ...
    <td style="padding:0;"><input id="dl_ansprechpartner" type="text" readonly="true" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['DL']->value['Ansprechpartner'], ENT_QUOTES, 'ISO-8859-1', true);?>
" name="DL[Ansprechpartner]" class="itxt itxt2col"></td>
  </tr>
  <tr>
    <td style="padding:0;"><label for="dl_strasse" style="width:180px;">Strasse</label></td>
    <td style="padding:0;"><input id="dl_strasse" type="text" readonly="true" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['DL']->value['Strasse'], ENT_QUOTES, 'ISO-8859-1', true);?>
" name="DL[Strasse]" class="itxt itxt2col"></td>
  </tr>
  <tr>
    <td style="padding:0;"><label for="dl_ort" style="width:180px;">Ort</label></td>
    <td style="padding:0;"><input id="dl_ort" type="text" readonly="true" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['DL']->value['Ort'], ENT_QUOTES, 'ISO-8859-1', true);?>
" name="DL[Ort]" class="itxt itxt2col"></td>
  </tr>
  <tr>
    <td style="padding:0;"><label for="dl_handy" style="width:180px;">Handy</label></td>
    <td style="padding:0;"><input id="dl_handy" type="text" readonly="true" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['DL']->value['Handy'], ENT_QUOTES, 'ISO-8859-1', true);?>
" name="DL[Handy]" class="itxt itxt2col"></td>
  </tr>
  <tr>
    <td style="padding:0;"><label for="dl_festnetz" style="width:180px;">Festnetz</label></td>
    <td style="padding:0;"><input id="dl_festnetz" type="text" readonly="true" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['DL']->value['Festnetz'], ENT_QUOTES, 'ISO-8859-1', true);?>
" name="DL[Festnetz]" class="itxt itxt2col"></td>
  </tr>
  <tr>
    <td style="padding:0;"><label for="dl_email" style="width:180px;">E-Mail</label></td>
    <td style="padding:0;"><input id="dl_email" type="text" readonly="true" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['DL']->value['Email'], ENT_QUOTES, 'ISO-8859-1', true);?>
