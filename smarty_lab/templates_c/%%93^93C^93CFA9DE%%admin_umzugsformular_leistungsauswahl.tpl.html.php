<?php /* Smarty version 2.6.26, created on 2016-01-18 13:35:41
         compiled from admin_umzugsformular_leistungsauswahl.tpl.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'admin_umzugsformular_leistungsauswahl.tpl.html', 289, false),array('modifier', 'number_format', 'admin_umzugsformular_leistungsauswahl.tpl.html', 292, false),)), $this); ?>
...
<table class="MitarbeierItem" style="width:100%;">
    <thead>
        <tr>
            ...
            <td>Menge1&nbsp;M</td>
            <td>Menge2&nbsp;M</td>
            <?php if ($this->_tpl_vars['PreiseAnzeigen']): ?><td>Preis</td>
...
<?php endif; ?>" type="text"></td>
            ...
            <td><input class="menge<?php if ($this->_tpl_vars['creator'] == 'mertens'): ?> creator editable<?php else: ?> readonly<?php endif; ?>" name="L[menge_mertens][]"<?php if ($this->_tpl_vars['creator'] !== 'mertens'): ?> readonly="readonly"<?php endif; ?> value="<?php if (is_numeric ( $this->_tpl_vars['L']['menge_mertens'] )): ?><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['L']['menge_mertens'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, ",", ".") : number_format($_tmp, 2, ",", ".")); ?>
<?php endif; ?>" type="text"></td>
            <td><input class="menge menge2<?php if ($this->_tpl_vars['creator'] == 'mertens'): ?> creator editable<?php else: ?> readonly<?php endif; ?>" name="L[menge2_mertens][]"<?php if ($this->_tpl_vars['creator'] !== 'mertens' || empty ( $this->_tpl_vars['L']['leistungseinheit2'] )): ?> readonly="readonly"<?php endif; ?> value="<?php if (is_numeric ( $this->_tpl_vars['L']['menge2_mertens'] )): ?><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['L']['menge2_mertens'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, ",", ".") : number_format($_tmp, 2, ",", ".")); ?>
<?php endif; ?>" type="text"></td>
...
<table id="TplLeistungTable" style="display:none;">
        <tr class="row inputRowVon">
            ...
            <td><input class="ilstg" name="L[leistung_id][]" disabled="disabled" value="" type="hidden"><!--
             --><input class="menge<?php if ($this->_tpl_vars['creator'] == 'property'): ?> creator editable<?php else: ?> readonly<?php endif; ?>" name="L[menge_property][]"<?php if ($this->_tpl_vars['creator'] !== 'property'): ?> readonly="readonly"<?php endif; ?> disabled="disabled" value="" type="number"></td>
            <td class="unit"></td>
            <td><input class="menge menge2<?php if ($this->_tpl_vars['creator'] == 'property'): ?> creator editable<?php else: ?> readonly<?php endif; ?>" name="L[menge2_property][]"<?php if ($this->_tpl_vars['creator'] !== 'property'): ?> readonly="readonly"<?php endif; ?> disabled="disabled" value="" type="number"></td>
            <td class="unit unit2"></td>
            <td><input class="menge<?php if ($this->_tpl_vars['creator'] == 'mertens'): ?> creator editable<?php else: ?> readonly<?php endif; ?>" name="L[menge_mertens][]"<?php if ($this->_tpl_vars['creator'] !== 'mertens'): ?> readonly="readonly"<?php endif; ?> disabled="disabled" value="" type="number"></td>
            <td><input class="menge menge2<?php if ($this->_tpl_vars['creator'] == 'mertens'): ?> creator editable<?php else: ?> readonly<?php endif; ?>" name="L[menge2_mertens][]"<?php if ($this->_tpl_vars['creator'] !== 'mertens'): ?> readonly="readonly"<?php endif; ?> disabled="disabled" value="" type="number"></td>
