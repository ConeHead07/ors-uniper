<?php
/* Smarty version 3.1.34-dev-7, created on 2021-11-10 12:12:28
  from '/var/www/html/html/umzugsteam_umzugsformular.tpl.read.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_618bb72c092b97_18802167',
...
function content_618bb72c092b97_18802167 (Smarty_Internal_Template $_smarty_tpl) {
...
">
      ...
      <div style="min-height:1.5rem;margin-top:.8rem;">
        ...
        <div id="imgSignatureBoxMertens"
             ...
             style="display: inline-block;width:15rem;min-height:1.5rem;border-bottom:2px solid black;">
      ...
      <div style="min-height:1.5rem;margin-top:.8rem;">
        <label style="margin-right:3rem;width:initial;">Ankunft <span style="border-bottom:1px solid black;margin-left:1rem;"><input name="ankunft" id="ankunftsZeit" type="time" size="8" class="input-bg-color"> Uhr</span></label>
        <label style="margin-right:3rem;width:initial;">Abfahrt <span style="border-bottom:1px solid black;margin-left:1rem"><input name="abfahrt" id="abfahrtsZeit" type="time" size="8" class="input-bg-color"> Uhr</span></label>
      </div>
...
?>
          <?php if ($_smarty_tpl->tpl_vars['L']->value['kategorie_id'] == "18" || $_smarty_tpl->tpl_vars['L']->value['kategorie_id'] == "25") {?>
           <?php continue 1;?>
          <?php }?>
        <label style="margin-right:3rem;width:initial;padding: 10px 3px 5px 0" class="input-bg-color" >
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
      ...
      <div style="margin-top:.5rem;">
        <div style="display:inline-block;margin-right:2rem;margin-top:1rem;">
          <div
                  class="input-bg-color"
                  style="border-bottom:2px solid black;min-height:1.5rem;width:8rem;display: inline-flex;">
        ...
        <div style="display:inline-block;margin-right:2rem;">
          <div
                  class="input-bg-color"
                  style="border-bottom:2px solid black;min-height:1.5rem;width:14rem;display: inline-flex;">
...
"
        ...
        <div style="display:inline-block;">
          <div id="imgSignatureBoxMA"
               class="input-bg-color"
               style="border-bottom:2px solid black;min-height:1.5rem;display: inline-flex;width:15rem;">
