<?php /* Smarty version 2.6.26, created on 2016-01-18 09:13:07
         compiled from admin_antraege_liste.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'admin_antraege_liste.html', 54, false),)), $this); ?>
...
&cat=neue<?php if ($this->_tpl_vars['allusers']): ?>&allusers=1<?php endif; ?>" style="width:90px">Neue Anträge</a></li>
        <li <?php if ($this->_tpl_vars['cat'] == 'angeboten'): ?>class="activeTab"<?php endif; ?>><a href="?s=<?php echo $this->_tpl_vars['s']; ?>
&cat=angeboten<?php if ($this->_tpl_vars['allusers']): ?>&allusers=1<?php endif; ?>" style="width:125px">zur Genehmigung</a></li>
        <li <?php if ($this->_tpl_vars['cat'] == 'aktive'): ?>class="activeTab"<?php endif; ?>><a href="?s=<?php echo $this->_tpl_vars['s']; ?>
&cat=aktive<?php if ($this->_tpl_vars['allusers']): ?>&allusers=1<?php endif; ?>" style="width:105px">Aktive Anträge</a></li>
        <li <?php if ($this->_tpl_vars['cat'] == 'abgeschlossene'): ?>class="activeTab"<?php endif; ?>><a href="?s=<?php echo $this->_tpl_vars['s']; ?>
&cat=abgeschlossene<?php if ($this->_tpl_vars['allusers']): ?>&allusers=1<?php endif; ?>" style="width:150px">Abgeschlossene Anträge</a></li>
        <li <?php if ($this->_tpl_vars['cat'] == 'temp'): ?>class="activeTab"<?php endif; ?>><a href="?s=<?php echo $this->_tpl_vars['s']; ?>
&cat=temp<?php if ($this->_tpl_vars['allusers']): ?>&allusers=1<?php endif; ?>" style="width:30px">Tmp</a></li>
        <li <?php if ($this->_tpl_vars['cat'] == 'zurueckgegeben'): ?>class="activeTab"<?php endif; ?>><a href="?s=<?php echo $this->_tpl_vars['s']; ?>
&cat=zurueckgegeben<?php if ($this->_tpl_vars['allusers']): ?>&allusers=1<?php endif; ?>" style="width:60px;color:#ffd700;">Zur&uuml;ck</a></li>
        <li <?php if ($this->_tpl_vars['cat'] == 'abgelehnte'): ?>class="activeTab"<?php endif; ?>><a href="?s=<?php echo $this->_tpl_vars['s']; ?>
&cat=abgelehnte<?php if ($this->_tpl_vars['allusers']): ?>&allusers=1<?php endif; ?>" style="width:60px;color:#ffd700;">Abgelehnt</a></li>
        <li <?php if ($this->_tpl_vars['cat'] == 'stornierte'): ?>class="activeTab"<?php endif; ?>><a href="?s=<?php echo $this->_tpl_vars['s']; ?>
&cat=stornierte<?php if ($this->_tpl_vars['allusers']): ?>&allusers=1<?php endif; ?>" style="width:60px;color:#ffd700;">Storno</a></li>
        <li <?php if ($this->_tpl_vars['cat'] == 'suche'): ?>class="activeTab"<?php endif; ?>><a href="?s=umzugssuche<?php if ($this->_tpl_vars['allusers']): ?>&allusers=1<?php endif; ?>" style="width:60px">Suche</a></li>
...
<?php if ($this->_tpl_vars['cat'] == 'angeboten'): ?>
