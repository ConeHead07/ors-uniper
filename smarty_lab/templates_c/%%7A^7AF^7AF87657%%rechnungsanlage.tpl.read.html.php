<?php /* Smarty version 2.6.26, created on 2016-02-10 22:28:52
         compiled from rechnungsanlage.tpl.read.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'rechnungsanlage.tpl.read.html', 81, false),array('modifier', 'date_format', 'rechnungsanlage.tpl.read.html', 81, false),array('modifier', 'substr', 'rechnungsanlage.tpl.read.html', 85, false),array('modifier', 'lower', 'rechnungsanlage.tpl.read.html', 93, false),)), $this); ?>
<html>
<head>
...
<h1 style="font-size:1.5em">Rechnungsanlage</h1>
...
<table>
  ...
  <tr>
      <td class="th"><label for="mitarbeiter"><b><?php if ($this->_tpl_vars['AS']['angeboten_am']): ?>Genehmigt<?php else: ?>Best&auml;tigt<?php endif; ?></b></label></td>
    <td class="status_<?php echo $this->_tpl_vars['AS']['genehmigt_br']; ?>
"><img id="imgStatGen" src="<?php echo $this->_tpl_vars['MConf']['WebRoot']; ?>
images/status_<?php echo ((is_array($_tmp=$this->_tpl_vars['AS']['genehmigt_br'])) ? $this->_run_mod_handler('lower', true, $_tmp) : smarty_modifier_lower($_tmp)); ?>
...
<?php endif; ?></span></td>
  ...
  <tr>
      <td class="th"><label for="mitarbeiter"><b>Abgeschlossen</b></label></td>
    <td class="status_<?php echo $this->_tpl_vars['AS']['abgeschlossen']; ?>
"><img id="imgStatAbg" src="<?php echo $this->_tpl_vars['MConf']['WebRoot']; ?>
images/status_<?php echo ((is_array($_tmp=$this->_tpl_vars['AS']['abgeschlossen'])) ? $this->_run_mod_handler('lower', true, $_tmp) : smarty_modifier_lower($_tmp)); ?>
...
<?php endif; ?></span></td>
  ...
  <tr>
      <td class="th"><label for="umzugsstatus"><b>Status</b></label></td>
    <td><?php if (empty ( $this->_tpl_vars['AS']['angeboten_am'] ) && ((is_array($_tmp=$this->_tpl_vars['AS']['umzugsstatus'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)) == 'genehmigt'): ?>bestaetigt<?php else: ?><?php echo ((is_array($_tmp=$this->_tpl_vars['AS']['umzugsstatus'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<?php endif; ?></td>
  </tr>
</table>    
<br>    
...
<table>
 ...
 <?php echo ((is_array($_tmp=$this->_tpl_vars['AS']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
  ...
  <tr>
    <td style="" class="th"><label for="kostenstelel"><b><?php echo $this->_tpl_vars['ASConf']['kostenstelle']['label']; ?>
</b></label></td>
...
<table>
  <tr>
    <td style="width:140px" class="th"><label for="ansprechpartner"><b>Vor &amp; Nachname</b></label></td>
    <td style="width:340px;"><?php echo ((is_array($_tmp=$this->_tpl_vars['AS']['ansprechpartner'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td>
  </tr>
  <tr>
    <td style="" class="th"><label for="termin"><b>E-Mail</b></label></td>
