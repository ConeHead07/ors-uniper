...
/**
 * Deaktiviert:
 * Ausblenden von Gebäuden über Config-Liste gilt nur für NIA-Report
...
WHERE LENGTH(gebaeude) > 0 AND gebaeude NOT LIKE \"%POOL%\"
GROUP BY `gebaeude`
...
WHERE LENGTH(i.gebaeude)>0 AND i.gebaeude NOT LIKE \"%POOL%\"\n";
...
// Deaktiviert: Gebäudeauswahl über Config-Liste (Gilt nur für NIA)
// i.`gebaeude` IN ('".implode("','", $aValidGP)."') AND  
