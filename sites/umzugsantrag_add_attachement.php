...
<form name="frmImUp" <?php if ($target !== 'lieferscheine'): ?> onsubmit="showLoadingBar(1, '')"<?php else: ?> onsubmit="checkUpload()"<?php endif; ?>
    ...
    <?php if ($target === 'lieferscheine'): ?><input type="submit" value="senden"><?php endif; ?>
</form>
</body>
</html>
<?php 
