...
$sql.= "WHERE um.umzugsart != \"Datenpflege\" AND ua.abgeschlossen = \"Ja\" \n";
$sql.= "AND DATE_FORMAT(ua.umzugstermin, \"%Y-%m-%d\") >= \"".$db->escape($statVon)."\" \n";
$sql.= "AND DATE_FORMAT(ua.umzugstermin, \"%Y-%m-%d\") <= \"".$db->escape($statBis)."\" \n";
